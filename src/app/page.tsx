...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-8 lg:p-24 bg-slate-950 text-gray-100">
      <div>
...
function CSSPathResearch() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-8 mb-10 w-full">
        {cards.map((card, i) => (
      ...
      <div className="m-2 mx-auto text-center flex-col ">
        <h2 className='text-xl font-bold '>
          Complex animations with GSAP
        </h2>
        <a href="https://gsap.com/resources/SVG" target="_blank" rel="noopener noreferrer" className="text-center text-white hover:text-blue-400">
